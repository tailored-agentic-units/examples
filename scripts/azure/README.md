...
`--resource-group` | Resource group name | `taugroup`
`--cognitive-service` | Cognitive services account name | `tau-ai`
`--cognitive-services-sku` | SKU for cognitive services | `S0`
`--cognitive-service-kind` | Type of cognitive service | `OpenAI`
`--cognitive-service-domain` | Custom subdomain for the service | `tau-ai`
`--cognitive-service-role` | Role to grant for bearer token access | `Cognitive Services OpenAI User`
`--model-deployment` | Model deployment name | `gpt-5-mini`
`--model-name` | AI model name | `gpt-5-mini`
`--model-version` | Model version | `2025-08-07`
`--model-format` | Model format | `OpenAI`
`--model-sku` | Model SKU | `GlobalStandard`
`--model-sku-capacity` | Model capacity | `1000`
...
Parameter | Description | Default Value
----------|-------------|--------------
`--resource-group` | Resource group to delete | `taugroup`
`--location` | Azure region | `eastus`
`--cognitive-service` | Cognitive service name to purge | `tau-ai`
...
Parameter | Description | Default Value
----------|-------------|--------------
`--resource-group` | Resource group containing the service | `taugroup`
`--cognitive-service` | Cognitive service account name | `tau-ai`
