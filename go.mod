module github.com/tailored-agentic-units/examples
...
require (
	...
	github.com/tailored-agentic-units/container/docker v0.1.0
	github.com/tailored-agentic-units/format v0.1.0
	github.com/tailored-agentic-units/format/converse v0.1.0
	...
	github.com/tailored-agentic-units/provider/bedrock v0.1.0
